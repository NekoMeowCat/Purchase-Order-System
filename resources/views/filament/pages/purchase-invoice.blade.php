    ...
    <main class="min-w-full border border-green-500 p-2">
        <header class="flex flex-col items-center border border-red-500 p-2 w-full">
            ...
            <article class="flex min-w-full border h-auto m-2">
                <div class="flex justify-end w-full">
                    <p>P.O NO. :_______________________________</p>
                </div>
            </article>
            <article class="grid grid-cols-2 gap-2 w-full">
                <div class="border">Supplier :_________________________________________________________________________</div>
                <div class="flex justify-end border">Date :_______________________________</div>
            </article>
            <article class="flex justify-start w-full">
                <small class="pl-16 text-slate-500">Purchase furnish us the following listed hereunder subject to terms and conditions set forth below:</small>
            </article>
            <article class="grid grid-cols-2 gap-2 w-full">
                <div class="border">Terms :_________________________________________________________________________</div>
        ...
        <section class="w-full border border-blue-500 mt-2 p-2 hover:bg-blue-100">
            ...
            <article class="grid grid-cols-3 gap-2 border p-1">
                <span class="border w-full text-sm text-gray-700">
                    Prepared By:
                </span>
                <span class="border w-full text-sm text-gray-700">
